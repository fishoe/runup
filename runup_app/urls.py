...
urlpatterns = [
    path('', views.nonepg), #메인 페이지
    path('index', views.nonepg, name = 'main'), #메인 페이지
    path('<int:product_id>', views.nonepg, name = 'product'), #제품 페이지
    path('likes', views.nonepg, name = 'likes'), #좋아요 리스트
    path('like/<int:product_id>',views.nonepg, name = 'like'), #좋아요 action 대응 ajax url
    ...
    path('singup', views.nonepg, name = 'signin'), #가입 페이지
